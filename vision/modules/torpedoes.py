...
options = [
    ...
    DoubleOption('scale_factor', 2, 1, 10),
...
class FeatureMatcher:
    ...
    def __init__(self, templates, flann_checks, min_matches, gray_func=None):
        ...
        if gray_func is None:
            gray_func = lambda mat: cv2.split(cv2.cvtColor(mat, cv2.COLOR_BGR2LAB))[0]
    ...
    def process(self, mat):
        ...
        for name, match in zip(['tentacle', 'squid'], self.matcher.match(shrunk, self.options['debug'])):
            ...
            if match is not None:
                ...
                skew = (right_height - left_height) / results.height
